...
password = input("ReMarkable root password: ")
...
for filename in filenames:
    ...
    manager.put_file(filename, "/usr/share/remarkable/templates/" + filename+".png")
    manager.put_file(filename, "/usr/share/remarkable/templates/" + filename+".svg")
